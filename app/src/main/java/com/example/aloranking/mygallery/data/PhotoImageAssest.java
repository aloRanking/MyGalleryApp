package com.example.aloranking.mygallery.data;

import com.example.aloranking.mygallery.R;

import java.util.ArrayList;
import java.util.List;

public class PhotoImageAssest {

    public static final List<Integer> bodyParts = new ArrayList<Integer>() {{
    ...
    public static List<Integer> getBodyParts() {
        return bodyParts;
    }
}
